...
<div class="gallery container-fluid" id="gallery">
  <div class="justify-content-center"> 
    <div class="mb-3 pics animation all 2">
      <img class="img-fluid" id="image1" src={require('./../Res/images/gallery/ares.jpg')} alt="Card image cap"/>
